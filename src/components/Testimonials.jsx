...
const Testimonials = () => {
  ...
  // This determines how many testimonials to show based on the screen size
  ...
  return (
    <>
      <div className="mt-20 tracking-wide px-4 md:px-8 lg:px-32 py-10">
        ...
        <div className="relative max-w-7xl mt-10 md:mt-24 mx-auto">
          <div className="overflow-hidden">
            ...
            >
              {testimonials.map((testimonial, index) => (
                <div
                  key={index}
                  className={`w-full ${testimonialsPerView === 2 ? "md:w-1/2" : testimonialsPerView === 3 ? "lg:w-1/3" : ""} flex-shrink-0 px-4`}
                >
